defmodule Tester.Scan4transports.Scan4transport do
  ...
  def changeset(scan4transport, attrs) do
    scan4transport
    |> cast(attrs, [:symbol, :sscc, :uri_stem, :gnic, :grai, :gsin, :routing_code, :to_gln, :for_gln, :service_code_desc, :dangerous_goods_flag, :ship_to_address, :ship_to_company, :ship_to_contact, :ship_to_address1, :ship_to_address2, :ship_to_surburb, :ship_to_locality, :ship_to_region, :ship_to_country_code, :ship_to_postal_code, :ship_to_phone_number, :ship_to_geocode, :latitude, :longitude, :authority_to_leave, :signature_flag, :before_delivery_date, :not_after_delivery_date, :release_date, :return_address, :return_to_company, :return_to_contact, :return_to_address1,:return_to_address2,:return_to_address2,:return_to_surburb,:return_to_locality,:return_to_region,:return_to_country_code,:return_to_postal_code,:return_to_phone_number,:logistic_weight,:length_first_dimension,:width_second_dimension,:depth_thickness_height,:logistic_volume])
    |> validate_required([:symbol, :sscc, :uri_stem, :gnic, :grai, :gsin, :routing_code, :to_gln, :for_gln, :service_code_desc, :dangerous_goods_flag, :ship_to_address, :ship_to_company, :ship_to_contact, :ship_to_address1, :ship_to_address2, :ship_to_surburb, :ship_to_locality, :ship_to_region, :ship_to_country_code, :ship_to_postal_code, :ship_to_phone_number, :ship_to_geocode, :latitude, :longitude, :authority_to_leave, :signature_flag, :before_delivery_date, :not_after_delivery_date, :release_date, :return_address, :return_to_company, :return_to_contact, :return_to_address1,:return_to_address2,:return_to_address2,:return_to_surburb,:return_to_locality,:return_to_region,:return_to_country_code,:return_to_postal_code,:return_to_phone_number,:logistic_weight,:length_first_dimension,:width_second_dimension,:depth_thickness_height,:logistic_volume])
  end
end
