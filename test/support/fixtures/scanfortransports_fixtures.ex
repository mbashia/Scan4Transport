defmodule Tester.ScanfortransportsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Tester.Scanfortransports` context.
  """

  @doc """
  Generate a scanfortransport.
  """
  def scanfortransport_fixture(attrs \\ %{}) do
    {:ok, scanfortransport} =
      attrs
      |> Enum.into(%{
      ...
      |> Tester.Scanfortransports.create_scanfortransport()
