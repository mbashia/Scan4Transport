defmodule Tester.ScanfortransportsTest do
  ...
  describe "scanfortransports" do
    ...
    test "create_scanfortransport/1 with valid data creates a scanfortransport" do
      ...
      assert {:ok, %Scanfortransport{} = scanfortransport} = Scanfortransports.create_scanfortransport(valid_attrs)
    ...
    test "create_scanfortransport/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Scanfortransports.create_scanfortransport(@invalid_attrs)
    end
    ...
    test "update_scanfortransport/2 with valid data updates the scanfortransport" do
      ...
      assert {:ok, %Scanfortransport{} = scanfortransport} = Scanfortransports.update_scanfortransport(scanfortransport, update_attrs)
    ...
    test "update_scanfortransport/2 with invalid data returns error changeset" do
      scanfortransport = scanfortransport_fixture()
      assert {:error, %Ecto.Changeset{}} = Scanfortransports.update_scanfortransport(scanfortransport, @invalid_attrs)
    ...
    test "delete_scanfortransport/1 deletes the scanfortransport" do
      scanfortransport = scanfortransport_fixture()
      assert {:ok, %Scanfortransport{}} = Scanfortransports.delete_scanfortransport(scanfortransport)
      assert_raise Ecto.NoResultsError, fn -> Scanfortransports.get_scanfortransport!(scanfortransport.id) end
    end
